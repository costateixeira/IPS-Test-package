// GENERATED by build-test-ig.mjs from ips-creator.feature. Edit the feature, not this file.
//
...
Instance: ips-creator-tests
InstanceOf: TestPlan
Usage: #definition
Title: "IPS Creator Test Plan"
Description: "Test plan for the IPS Creator actor of HL7 International Patient Summary (IPS) 2.0.1."
...
* description = """
Test plan for the **IPS Creator** actor of [HL7 International Patient Summary (IPS) 2.0.1](https://hl7.org/fhir/uv/ips/).
